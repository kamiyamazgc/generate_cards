...
TRANS_TOK   = 2048
TRANS_SYSTEM_PROMPT = (
    "You are a professional translator proficient in many languages. "
    "Translate the user message into natural, accurate Japanese without "
    "omitting or adding content."
)
...
def translate_full(text: str) -> str:
    ...
    for chunk in chunk_text(text, max_tokens=TRANS_TOK - instr_tok - sys_tok):
        prompt = instr + chunk
